...
# ARI Comparison
ggplot(aggregated_results, aes(x = Missingness_level, y = Mean_ARI, fill = Imputation_method)) +
  geom_bar(stat = "identity", position = position_dodge()) +
  facet_wrap(~Missingness_method) +
  labs(title = "Adjusted Rand Index (ARI) Comparison", x = "Missingness Level", y = "Mean ARI")

# NMI Comparison
ggplot(aggregated_results, aes(x = Missingness_level, y = Mean_NMI, fill = Imputation_method)) +
  geom_bar(stat = "identity", position = position_dodge()) +
  facet_wrap(~Missingness_method) +
  labs(title = "Normalized Mutual Information (NMI) Comparison", x = "Missingness Level", y = "Mean NMI")

# Silhouette Score Comparison
ggplot(aggregated_results, aes(x = Missingness_level, y = Mean_Silhouette_Score, fill = Imputation_method)) +
  geom_bar(stat = "identity", position = position_dodge()) +
  facet_wrap(~Missingness_method) +
  labs(title = "Silhouette Score Comparison", x = "Missingness Level", y = "Mean Silhouette Score")
...
# Conclusion
why was this useful and what have we learned about the method

- agregation des resultats par missingness methods, par imputation de méthodes
