...
# Report average measurements by Missingness_method, Imputation_method, Missingness_level


# Visual Representation
# Create side-by-side boxplots to compare performance under different scenarios
avg_missingness <- aggregate(cbind(ARI, NMI, Silhouette_Score) ~ Missingness_method, data = df, mean)
avg_imputation <- aggregate(cbind(ARI, NMI, Silhouette_Score) ~ Imputation_method, data = df, mean)
avg_miss_level <- aggregate(cbind(ARI, NMI, Silhouette_Score) ~ Missingness_level, data = df, mean)
