...
simulation_results[[paste('MCAR', 'mean', missing_rate, repetition, sep = '_')]] <- performance_metrics_list[['mean_MCAR']]
    simulation_results[[paste('MCAR', 'median', missing_rate, repetition, sep = '_')]] <- performance_metrics_list[['median_MCAR']]
    simulation_results[[paste('MCAR', 'knn', missing_rate, repetition, sep = '_')]] <- performance_metrics_list[['knn_MCAR']]

    simulation_results[[paste('MNAR', 'mean', missing_rate, repetition, sep = '_')]] <- performance_metrics_list[['mean_MNAR']]
    simulation_results[[paste('MNAR', 'median', missing_rate, repetition, sep = '_')]] <- performance_metrics_list[['median_MNAR']]
    simulation_results[[paste('MNAR', 'knn', missing_rate, repetition, sep = '_')]] <- performance_metrics_list[['knn_MNAR']]
    
    simulation_results[[paste('MAR', 'mean', missing_rate, repetition, sep = '_')]] <- performance_metrics_list[['mean_MAR']]
    simulation_results[[paste('MAR', 'median', missing_rate, repetition, sep = '_')]] <- performance_metrics_list[['median_MAR']]
    simulation_results[[paste('MAR', 'knn', missing_rate, repetition, sep = '_')]] <- performance_metrics_list[['knn_MAR']]
    
    # Store the metrics for this iteration
    metrics_vector <- unlist(performance_metrics_list)
    performance_metrics <- rbind(performance_metrics, metrics_vector)
  }
}
```
# Conclusion
